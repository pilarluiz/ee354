...
HD_PWD='C:/Xilinx_projects/test_nexys4_verilog/testN4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_nexys4_verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_nexys4_verilog.tcl -notrace
