...
HD_PWD='C:/Xilinx_projects/test_nexys4_verilog/testN4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_nexys4_verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_nexys4_verilog.tcl
